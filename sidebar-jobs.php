...
$user = new UserData(new WP_User(get_field('quan_job_user')['ID']));

	//the author sidebar
	$aat_user = get_field('quan_job_user');
	$aat_user_mail = get_field('quan_job_email');
	$aat_user_phone = get_field('quan_job_phone');
...
?>
	<aside id="sidebar">
		...
		<div class="job-share">
			...
			<h3><?php _e('Share this job', 'quan'); ?></h3>
